      ...
      <div class="col-12 col-md-8 col-lg-6 col-xl-5">
        <div class="card shadow-2-strong" style="border-radius: 1rem;">
          <div class="card-body p-5 text-center">
            ...
            <hr color="black">
            <h4 class="mb-3">Promo Codes</h4>
            <hr color="black">
	<c:choose>
		<c:when test="${Promos.length()>0}">
		    <h4 class="mb-3">You have a promo code!</h4>
			
			<h4 class="mb-3">${Promos}</h4>
			<h4 class="mb-3">Use it while booking to get a 20% discount!</h4>
		</c:when>
		<c:otherwise>
		    <h4 class="mb-3">No promo codes yet...</h4>
		</c:otherwise>
	</c:choose>
	<hr class="my-4">
