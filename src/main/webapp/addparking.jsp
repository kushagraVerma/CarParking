        ...
        <div class="card shadow-2-strong" style="border-radius: 1rem;">
          ...
          <form class="form-sigin" action="addnewlocpark" method="post">
           ...
           <div class="form-outline mb-3">
            <input type="text" id="typeuname" class="form-control form-control-lg" name="newloc"  maxlength="128" required />
              <label class="form-label" for="typeuname">New Location</label>
            </div>
            <input class="btn btn-primary btn-lg btn-block" name="emlOTP" type="submit" value="Add parking">
</form>
<hr class="my-4">
<form class="form-sigin" action = "addnewlocpark" method ="post">
		...
		<input class="btn btn-primary btn-lg btn-block" type="submit" value="Add parking">
	</form>
	<%
